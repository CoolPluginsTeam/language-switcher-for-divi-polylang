 ...
 */
 ...
 $lsdp_polylang_support = esc_url("https://my.coolplugins.net/account/support-tickets/");
?>
...
<ul>
      ...
      <br/>
      <a href="<?php echo esc_url($lsdp_polylang_support); ?>" target="_blank" class="button button-primary">👉 Plugin Support</a>
      <br/><br/>
</div>
