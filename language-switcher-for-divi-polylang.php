...
if (! class_exists('LANGUAGE_SWITCHER_FOR_DIVI_POLYLANG')) {
	class LANGUAGE_SWITCHER_FOR_DIVI_POLYLANG
	{
		...
		public function lsdp_init()
		{
			...
			// Theme Builder integration: Polylang language conditions for Divi 4+.
			// Added 2026-05-22 — Marco Traina <https://www.trainaepartners.it>
			// Registers "Languages (Polylang)" condition group in the Divi Theme
			// Builder UI and provides per-language layout filtering.
			require_once LSDP_DIR . 'includes/theme-builder/class-lsdp-theme-builder-conditions.php';
			new LSDP_Theme_Builder_Conditions();
			require_once LSDP_DIR . 'includes/theme-builder/class-lsdp-theme-builder-language-map.php';
			new LSDP_Theme_Builder_Language_Map();
		}
